...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="aksi/aov/admin.php"><i class="fa fa-table"></i>Admin</a></li>
            <li><a href="aksi/aov/user.php"><i class="fa fa-plus"></i>User</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="aksi/codm/admin.php"><i class="fa fa-table"></i>Admin</a></li>
            <li><a href="aksi/codm/user.php"><i class="fa fa-plus"></i>User</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="aksi/ff/admin.php"><i class="fa fa-table"></i>Admin</a></li>
            <li><a href="aksi/ff/user.php"><i class="fa fa-plus"></i>User</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="aksi/sd/admin.php"><i class="fa fa-table"></i>Admin</a></li>
            <li><a href="aksi/sd/user.php"><i class="fa fa-plus"></i>User</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <br>
      <center>
        <img src="../img/icon.png" height="400" width="400">
        <h1>SELAMAT DATANG DI WEBSITE ADMIN NOXIDE</h1>
      </center>
    </section>
    <!-- /.content -->
  </div>
