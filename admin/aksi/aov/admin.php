      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="admin.php"><i class="fa fa-table"></i>Admin</a></li>
            <li><a href="user.php"><i class="fa fa-table"></i>User</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="../codm/admin.php"><i class="fa fa-table"></i>Admin</a></li>
            <li><a href="../codm/user.php"><i class="fa fa-table"></i>User</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                      include '../koneksi.php';
                      $no = 1;
                      $data = mysqli_query($koneksi , "select * from aov");
                      while ($d = mysqli_fetch_array($data)){
                        ?>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $d['vcharga']; ?></td>
                          <td><a href="edit/FormEditAdmin.php?vcharga=<?php echo $d['vcharga']; ?>"><button class="btn btn-warning">EDIT DATA</button></td>
                          <td><a href="delete/DeleteAdmin.php?vcharga=<?php echo $d['vcharga']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapusnya?')"><button class="btn btn-danger">DELETE DATA</button></td>
                        </tr>
                        <?php
                      }
                        ?>
                ...
                <br>
                <a href="insert/inputadmin.php"><button class="btn btn-primary">TAMBAH DATA</button>
              </div>
              <!-- /.box-body -->
            </div>
            <!-- /.box -->
