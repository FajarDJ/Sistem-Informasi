...
<head>
  ...
  <title>ADMIN GSD | EDIT DATA ADMIN</title>
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <?php
                  include '../../koneksi.php';
                  $dmharga=$_GET['dmharga'];
                  $data = mysqli_query($koneksi , "SELECT*FROM sd WHERE dmharga='$dmharga'");
                  ...
                  <form method="post" action="UpdateDataAdmin.php">
                    <table>
                      ...
                      <tr>
                        <td>Diamonds dan Harga : </td>
                        <td><input type="text" name="dmharga" value="<?php echo $d['dmharga']; ?>"></td>
                      </tr>
                      <tr>
