                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                      include '../koneksi.php';
                      $no = 1;
                      $data = mysqli_query($koneksi , "select * from codm");
                      while ($d = mysqli_fetch_array($data)){
                        ?>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $d['cpharga']; ?></td>
                          <td><a href="edit/FormEditAdmin.php?cpharga=<?php echo $d['cpharga']; ?>"><button class="btn btn-warning">EDIT DATA</button></td>
                          <td><a href="delete/DeleteAdmin.php?cpharga=<?php echo $d['cpharga']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapusnya?')"><button class="btn btn-danger">DELETE DATA</button></td>
                        </tr>
                        <?php
                      }
                      ?>
