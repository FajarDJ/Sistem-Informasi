...
<head>
  ...
  <title>ADMIN CODM | EDIT DATA ADMIN</title>
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <?php
                  include '../../koneksi.php';
                  $cpharga=$_GET['cpharga'];
                  $data = mysqli_query($koneksi , "SELECT*FROM codm WHERE cpharga='$cpharga'");
                  ...
                  <form method="post" action="UpdateDataAdmin.php">
                    <table>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="cpharga" value="<?php echo $d['cpharga']; ?>"></td>
                      </tr>
                      <tr>
