...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <font color="white">Call of Duty: Mobile adalah permainan video tembak-menembak orang-pertama gratis yang dikembangkan oleh Tencent Games dan diterbitkan oleh Activision untuk serambi Android dan iOS. Permainan ini dirilis sebagai beta di negara-negara tertentu pada bulan Juli 2019, dan secara resmi dirilis pada tanggal 1 Oktober 2019.</font>
    </div>
  </section><!-- #hero -->
  ...
  <main id="main">
    <section id="topup">
      <div class="container wow fadeInUp">
        ...
        <table align="Center">
          <form method="post" action="insertcodm.php">
            <tr>
          ...
          <table align="Center">
            <tr>
              <td align="Center"><h5>PILIH CALL OF DUTY POINT</h5></td>
            </tr>
            <tr>
              <td><select class="form-control" name="cpharga" style="width:450px; height:50px;" required>
              <?php
              include '../../koneksi.php';
                  $data = mysqli_query($koneksi , "select cpharga from codm");
                  while ($d = mysqli_fetch_array($data)) { ?>
                  <option style="text-align:Center;"><?= $d['cpharga'];?></option>
              <?php } ?>
              </select></td>
            </tr>
          </table>
