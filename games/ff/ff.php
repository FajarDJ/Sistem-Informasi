  ...
  <main id="main">
    <section id="topup">
      <div class="container wow fadeInUp">
        ...
        <table align="Center">
          <form method="post" action="insertff.php">
            <tr>
          ...
          <table align="Center">
            ...
            <tr>
              ...
              <?php
              include '../../koneksi.php';
                  $data = mysqli_query($koneksi , "select dmharga from ff");
